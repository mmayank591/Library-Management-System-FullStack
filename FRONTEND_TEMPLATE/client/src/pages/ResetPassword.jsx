...
const ResetPassword = () => {
  ...
  <div className="flex flex-col justify-center md:flex-row h-screen">
    ...
    <div className="text-center h-[450px]">
      ...
      <h3 className="text-gray-300 mb-12 max-w-[320px] mx-auto text-3xl font-medium leading-10">"Your premier digital library."</h3>
    </div>
    </div>
    {/* RIGHT SECTION */}
    <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative overflow-y-auto">
          ...
          <div className="w-full max-w-sm">
            ...
            <form onSubmit={handleResetPassword}>
              ...
              <button type="submit" className="border-2 mt-5 border-black w-full font-semibold bg-black
               text-white py-2 rounded-lg hover:bg-white hover:text-black transition"
               disabled={loading ? true : false}>RESET PASSWORD</button>
            </form>
          </div>
        </div>
  </div>
