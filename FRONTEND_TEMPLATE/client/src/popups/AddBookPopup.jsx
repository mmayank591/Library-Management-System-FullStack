        ...
        <div className='p-6'>
          ...
          <form onSubmit={handleAddBook}>
            ...
            <div className='mb-4'>
              ...
              placeholder="Book's Description" rows={4} className="w-full px-4 py-2 border-2 border-black rounded-md"
              />
            </div>
            <div className='flex justify-end space-x-4'>
              ...
              <button type="submit"
              className='px-4 py-2 bg-black text-white rounded-md hover:bg-gray-800'>Add</button>
            </div>
          </form>
        </div>
        </div>
